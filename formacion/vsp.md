...
The VSP (Viewtinet Sales Professional) is the entry-level certification for sales professionals who need to effectively position and sell the Viewtinet unified observability platform.
...
|---|---|
| Duration | 1 hour |
| Delivery | Online portal / Online session |
| Target audience | Professionals involved in sales processes |
| Assessment | None (no formal exam) |
| Certification | No formal certificate issued |
...
- Gain a comprehensive understanding of Viewtinet's unified observability value proposition
- Learn how to identify leads based on client needs and organizational profile
- Understand which key messages resonate with different client roles (IT managers, CIOs, network engineers)
- Understand why Viewtinet is unique compared to competing observability solutions
