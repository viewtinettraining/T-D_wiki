---
title: "Server Info"
description: "Viewtinet uses a machine-unique identifier for licensing. This identifier is contained in the file `/opt/vn/viewtimanager/var/server-info.txt` on the target ..."
