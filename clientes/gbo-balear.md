...
GBO Balear is an IT services and networking company operating in the Balearic Islands (Mallorca, Menorca, Ibiza, and Formentera), Spain. As a regional IT services provider, GBO Balear manages network infrastructure for business and public sector clients in an island context where reliable network performance monitoring is essential.
...
The project folder contains **5 PowerPoint presentations** (in a `PPTS/` subfolder):

| Module | Description |
|---|---|
| 01 | Welcome & Course Presentation |
| 02 | Viewtinet & Products |
| 03 | Architecture & Appliances |
| 04 | ViewtiMon |
| 05 | Viewtimanager |
