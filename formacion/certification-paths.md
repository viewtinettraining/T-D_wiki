...
The Viewtinet certification program is organized into five verticals, each targeting a distinct professional role or technical domain. The paths are designed to be progressive: foundational courses unlock access to advanced specializations.
...
```
VSP  ─────────────────────────────────  (Sales, standalone)

VC-PSP  ──────────────────────────────  (Presales, standalone)

VC-OA (VCOA) ─┬──► VC-DE  ───────────  (Viewtilog specialization)
               └──► VC-WDE ───────────  (ViewtiMon & ViewtifyQoS)
```
