...
description: "This page summarizes the full Installation Guide section of the Viewtinet documentation hub and links to all individual source files and the derived wiki pages."
keywords: "instalacion, fuente"
---
...
### Introduction
- about-installation-guide.md — Disclaimers, audience, and supported OS matrix
...
- preparing-the-installation-bundle.md — Download, upload, and extract the .zip bundle
- installation-step1.md — Step 1: run deploy.sh
- installation-step2.md — Step 2: run install.sh and re-login
- installation-step3.md — Step 3: run install.sh again (images + config)
...
- about-viewtilog.md — ViewtiLog overview
- standalone-installation.md (viewtilog) — ViewtiLog standalone installation
- cluster-installation.md (viewtilog) — ViewtiLog HA cluster installation
- about-viewtimon.md — ViewtiMon overview and NIC requirements
- standalone-installation.md (viewtimon) — ViewtiMon standalone installation
- fine-tuning.md — ViewtiMon kernel and CPU fine-tuning
- about-viewtify-qos.md — ViewtiQoS overview
- standalone-installation.md (viewtiqos) — ViewtiQoS installation
- about-viewtilog-guide-installation.md — ViewtiSight overview
- cluster-installation.md (viewtisight) — ViewtiSight cluster installation

### Appliance
- getting-to-know-your-appliance.md — Physical ports and hardware layout
- how-to-rack-your-appliance.md — Rail assembly and rack mounting procedure
- [ipmi-ip-address-configuration.md](../conceptos/ipmi-management.md) — BIOS-level IPMI IP setup
- managing-your-appliance-via-ipmi.md — Web-based IPMI remote console
- changing-the-management-ip-address.md — Script-based management IP change
